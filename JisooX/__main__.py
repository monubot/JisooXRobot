...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="✨ʜᴇʟᴘ",callback_data="help_back"),InlineKeyboardButton(text="✨ᴄʀᴇᴀᴛᴏʀ",url="https://t.me/mondisini")]]
    keyboard += [[InlineKeyboardButton(text="✨ᴄᴏɴɴᴇᴄᴛ", callback_data="main_connect"),InlineKeyboardButton(text="✨ᴀᴅᴅ ᴍᴇ",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⛑️ ʜᴇʟᴘ",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="👶 ᴄʀᴇᴀᴛᴏʀ",url="https://t.me/xflicks")]]))
        return
